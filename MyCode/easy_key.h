...
// #define USE_HAL_DRIVER 0        // If you use 3rd party driver, change this def to 0
#define PRESS_THRESHOLD 20      // Dithering elimination
#define HOLD_THRESHOLD 200      // Time longer than this is considered as "hold"
#define INTERVAL_THRESHOLD 150  // Trigger time interval less than this is considered as "multi click"
